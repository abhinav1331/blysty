		...
		<div class="profile-header">
			<div class="container-fluid">
				...
				<div class="tab-target">
					<ul>
						<li><a href="javascript:void(0)" data-tab="blysts">Blysts</a></li>
						<li class="active"><a href="javascript:void(0)" data-tab="blystboards">BlystBoards</a></li>
						<li><a href="javascript:void(0)" data-tab="followers">16 Followers</a></li>
						<li><a href="javascript:void(0)" data-tab="following">14 Following</a></li>
					</ul>
				</div>
			</div>
		</div>
								...
								<div class="wrapper">
									...
									<div class="edit-container">
										...
										<div class="link-con text-right">
											<a class="green-btn costom-btn" href="#">Edit</a>
										</div>
									</div>
								</div>
							</div>
