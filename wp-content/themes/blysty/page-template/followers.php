<?php 
/*
* Template Name: Followers Page Template
*/
get_header('main');
$users = new users();
$Pins = new Pins();
		...
		<div class="profile-header follower-container">
			<div class="container-fluid">
				<div class="followers rvs">	
					...
					<div class="folloers-cout"><h3><span><?php echo $users->followingCount($users1->ID , 'following_user_id') ?></span> Following <?php echo $users->viewUserDetails($users1->ID , "Name"); ?></h3></div>
				</div>
			</div>
		</div>
			...
			<div class="section-area lgray">
				<div class="container-fluid">
					<div class="followlers-list">
						<?php echo $users->followList($users1->ID , "following_user_id"); ?>
					</div>
				</div>
			</div>
		</div>
