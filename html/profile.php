		...
		<div class="profile-header">
			<div class="container-fluid">
				...
				<div class="tab-target">
					<ul>
						<li class="active"><a href="profile.php" data-tab="blysts">Blysts</a></li>
						<li><a href="blystyboards.php" data-tab="blystboards">BlystBoards</a></li>
				...
				<div class="container-fluid">
					...
					<div class="tab-section post-gallery">
						<div class="post-list grid">
							...
							<div class="grid-item post-wrapper">
								<div class="post">
									<figure class="post-tumb" style="background-image: url('images/post-img2.jpg');"></figure>
									<div class="post-details">
										<div class="post-header">
											<a href="#"><span>12</span><h3>Cutest Breeds of Small Dogs</h3></a>
										</div>

										<div class="post-info">
											<div class="avatar">
												<figure style="background-image: url('images/avatar2.jpg');"></figure>
											</div>
											<div class="post-arthur">
												<h4>Juli Lee</h4>
												<h5>Animals</h5>
										...
										<div class="liks">
											<div class="counter">
												<a href="#"><i class="fa fa-heart"></i> 66</a>
											</div>
										</div>
										<a href="javascript:void(0)" class="edit" data-toggle="modal" data-target="#editBlysty" >Edit Blyst</a>
									</div>
