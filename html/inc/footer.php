			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="browserBlysty popupinner">
						...
						<div class="modal-body">
							<img src="images/browser.jpg" alt="browser">
						</div>
							...
							<div class="chooseBlystyCategories form">
								<form>
									<div class="form-group">
										<input class="form-control" type="text" placeholder="Favorite Music">
							...
							<div class="head">
								...
								<form>
									...
									<div class="form-row">
										...
										<div class="newAvatar">
											<figure style="background-image: url('images/pop2.jpg');"></figure>
										</div>
									</div>
